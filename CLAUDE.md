...
2. Follow the phase order in whitepaper §5. Do not skip exit criteria. Current phase: **P2 (P0 and P1 complete: `tools/fetch-spec`, the spec archive, and `pkg/opendrive` client/auth/types/errors are in; next is binding the folder/file/sharing/users endpoints)**.
